    ...
    if ($action === 'add') {
        ...
        if (!empty($errors)) {
            ...
            try {
                ...
                $flash['err'] = 'افزودن ناموفق: ' . redfox_public_exception($e, 'panel/applinks.php');
            }
        }
    }
    elseif ($action === 'delete') {
        ...
        if ($id > 0) {
            try {
                ...
                $flash['err'] = 'حذف ناموفق: ' . redfox_public_exception($e, 'panel/applinks.php');
            }
        }
    }
}
...
if (!$tableMissing) {
    try {
        ...
        $flash['err'] = $flash['err'] ?: 'بارگذاری لیست ناموفق: ' . redfox_public_exception($e, 'panel/applinks.php');
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>لینک‌های برنامه | پنل رد فاکس</title>
