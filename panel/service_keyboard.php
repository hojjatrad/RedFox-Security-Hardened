...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($contentType !== 'application/json') {
        http_response_code(415); echo json_encode(['ok'=>false,'error'=>'json_required']); exit;
    }
    if ($declaredLength < 0 || $declaredLength > 65536) {
        http_response_code(413); echo json_encode(['ok'=>false,'error'=>'payload_too_large']); exit;
    }
...
<head>
    <meta name="rx-csrf-token" content="<?= htmlspecialchars(redfox_csrf_token(), ENT_QUOTES, 'UTF-8') ?>">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, viewport-fit=cover">
    <title>رنگ‌بندی دکمه‌ها — پنل رد فاکس</title>
    ...
    function doSave(){
        ...
        fetch('service_keyboard.php', {
            ...
            headers: {
                ...
                'X-CSRF-Token': (document.querySelector('meta[name="rx-csrf-token"]') || {}).content || ''
            },
