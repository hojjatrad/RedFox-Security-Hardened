(function () {
    ...
    var COLOR_KEY = 'redfox_color';
    var THEME_KEY = 'redfox_theme';
    ...
    function applyColor(value) {
        ...
        try { document.dispatchEvent(new CustomEvent('red fox:themechange', { detail: { color: preset ? preset : hex } })); } catch (e) {}
    }
    ...
    function applyTheme(theme) {
        ...
        try {
            document.dispatchEvent(new CustomEvent('red fox:themechange', { detail: { theme: theme } }));
        } catch (e) {}
    }
    ...
    function ready() {
        ...
        if (themeToggleBtn) {
            themeToggleBtn.addEventListener('click', function (ev) {
                ev.stopPropagation();
                window.RedFoxTheme.toggleTheme();
            });
        }
    }
