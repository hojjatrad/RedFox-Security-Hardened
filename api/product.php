...
switch ($data['actions'] ?? '') {
    ...
    case 'products':
        ...
        try {
            ...
            error_log("Database error in product: " . redfox_exception_fingerprint($e));
    ...
    case 'product_add':
        ...
        try {
            ...
            error_log("Error in product_add: " . redfox_exception_fingerprint($e));
    ...
    case 'product_edit':
        ...
        try {
            ...
            error_log("Error in product_edit: " . redfox_exception_fingerprint($e));
    ...
    case 'product_delete':
        ...
        try {
            ...
            error_log("Error in product delete : " . redfox_exception_fingerprint($e));
