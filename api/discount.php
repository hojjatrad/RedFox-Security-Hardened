...
switch ($data['actions'] ?? '') {
    ...
    case 'discounts':
        ...
        try {
            ...
            error_log("Database error in discount: " . redfox_exception_fingerprint($e));
    ...
    case 'discount_add':
        ...
        try {
            ...
            error_log("Error in Discount add: " . redfox_exception_fingerprint($e));
    ...
    case 'discount_delete':
        ...
        try {
            ...
            error_log("Error in Discount delete : " . redfox_exception_fingerprint($e));
    ...
    case 'discount_sell_delete':
        ...
        try {
            ...
            error_log("Error in DiscountSell delete : " . redfox_exception_fingerprint($e));
