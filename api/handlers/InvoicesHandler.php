...
final class InvoicesHandler extends BaseHandler
{
    public function handle(): void
    {
        ...
        $limit = RedFoxInput::intRange($this->data, 'limit', 1, 10, 10);
        $page  = RedFoxInput::intMin($this->data, 'page', 1, 1);
        $offset = ($page - 1) * $limit;

        $search = RedFoxInput::nullableString($this->data, 'q');
        ...
        $totalItems = (int) RedFoxDb::fetchScalar(
