...
switch ($data['actions'] ?? '') {
    ...
    case 'categorys':
        ...
        try {
            ...
            error_log("Database error in category: " . redfox_exception_fingerprint($e));
    ...
    case 'category_add':
        ...
        try {
            ...
            error_log("Error in category_add: " . redfox_exception_fingerprint($e));
    ...
    case 'category_edit':
        ...
        try {
            ...
            error_log("Error in category_edit: " . redfox_exception_fingerprint($e));
    ...
    case 'category_delete':
        ...
        try {
            ...
            error_log("Error in category delete : " . redfox_exception_fingerprint($e));
