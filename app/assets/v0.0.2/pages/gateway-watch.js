...
function _gwGetActive() {
    return (typeof window !== 'undefined') ? window.__redfoxGatewayWatchCleanup : null;
}
function _gwSetActive(fn) {
    if (typeof window !== 'undefined') {
        window.__redfoxGatewayWatchCleanup = (typeof fn === 'function') ? fn : null;
    }
}
        ...
        view.innerHTML = `
            <article class="card card-window watch-card">
                <header class="card-window-bar">
                    ...
                    <span class="window-url">${isCrypto ? 'red fox/crypto/watch' : 'red fox/gateway/watch'}</span>
                </header>
