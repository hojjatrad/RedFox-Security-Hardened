        ...
        view.innerHTML = `
            ...
            <article class="card card-window">
                <header class="card-window-bar">
                    ...
                    <span class="window-url">red fox/crypto/currency</span>
                </header>
                <div class="card-body">
    ...
    async function step3Invoice() {
        view.innerHTML = `
            ...
            <article class="card card-window">
                <header class="card-window-bar">
                    <span class="dots"><span></span><span></span><span></span></span>
                    <span class="window-url">red fox/crypto/invoice</span>
                </header>
                <div class="card-body">
    ...
    function renderInvoiceView() {
        ...
        view.innerHTML = `
            ...
            <article class="card card-window">
                <header class="card-window-bar">
                    <span class="dots"><span></span><span></span><span></span></span>
                    <span class="window-url">red fox/crypto/pay</span>
                </header>
                <div class="card-body">
                    ...
                    <div class="qr-panel mt-md">
                        <div class="qr-frame"><img id="crypto-wallet-qr" alt="QR" /></div>
                    </div>
        ...
        const qrImage = view.querySelector('#crypto-wallet-qr');
        setQrImage(qrImage, qrPayload, 560).catch(() => {
            if (qrImage) qrImage.alt = 'ساخت QR ناموفق بود';
        });
    ...
    function step4Hash() {
        ...
        view.innerHTML = `
            ...
            <article class="card card-window">
                <header class="card-window-bar">
                    <span class="dots"><span></span><span></span><span></span></span>
                    <span class="window-url">red fox/crypto/hash</span>
                </header>
                <div class="card-body">
            ...
            onSuccess: async (statusObj) => {
                ...
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/crypto/done</span>
                        </header>
            ...
            onFail: (statusObj) => {
                ...
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/crypto/fail</span>
                        </header>
                        <div class="card-body" style="text-align:center;padding:22px">
            ...
            onTimeout: () => {
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/crypto/timeout</span>
                        </header>
                        <div class="card-body" style="text-align:center;padding:22px">
