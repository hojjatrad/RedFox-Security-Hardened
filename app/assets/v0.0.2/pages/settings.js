...
function globalAccent() {
    ...
    try {
        const raw = localStorage.getItem('red fox.brand');
    ...
    view.innerHTML = `
        ...
        <article class="card card-window">
            <header class="card-window-bar">
                ...
                <span class="window-url">red fox/settings</span>
            </header>
    ...
    $save.addEventListener('click', async () => {
        ...
        try {
            ...
            try {
                ...
                cache.accent = saved;
                localStorage.setItem('red fox.brand', JSON.stringify(cache));
            } catch (_) {  }
...
function renderBrandFields(host, brand) {
    ...
    host.innerHTML = `
        ...
        <div class="form-row mt-md">
            ...
            <input id="brand-name-input" type="text" maxlength="40" placeholder="Red Fox" value="${escapeAttr(brand.name || '')}" />
        </div>
