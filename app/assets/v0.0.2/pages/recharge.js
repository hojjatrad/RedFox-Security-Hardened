    ...
    view.innerHTML = `
        ...
        <article class="card card-window">
            <header class="card-window-bar">
                ...
                <span class="window-url">red fox/recharge</span>
            </header>
            <div class="card-body">
            ...
            onSuccess: (st) => {
                ...
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/recharge/done</span>
                        </header>
            ...
            onFail: (st) => {
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/recharge/fail</span>
                        </header>
                        <div class="card-body" style="text-align:center;padding:22px">
            ...
            onTimeout: () => {
                view.innerHTML = `
                    <article class="card card-window">
                        <header class="card-window-bar">
                            <span class="dots"><span></span><span></span><span></span></span>
                            <span class="window-url">red fox/recharge/timeout</span>
                        </header>
                        <div class="card-body" style="text-align:center;padding:22px">
